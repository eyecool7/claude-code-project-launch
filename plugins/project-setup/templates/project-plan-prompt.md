...
## 사용 방법
project-plan-prompt.md를 열어서 [프로젝트 이름]과 프로젝트 개요를 채우세요.
프롬프트 전체 내용을 claude.ai 채팅창에 붙여넣고 대화하며 계획서를 완성하세요.
완성된 계획서를 project-plan.md로 저장하고 프로젝트 루트에 넣으세요.
/project-setup:refine 명령어를 실행하여 다음 단계로 넘어갑니다.
